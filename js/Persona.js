...
export const juegoPruebasPersonas = [
  new Persona("Nicolás","Martinez",46,12345754,"Durazno","Dependiente",true),
  new Persona("Ana", "González", 27, 23456789, "Canelones", "Estudiante", true),
  new Persona("Luis","Rodríguez",55,34567890,"Maldonado","Independiente",true),
  new Persona("María", "García", 67, 45678901, "Salto", "No Trabaja", true),
  new Persona("Pablo","Martínez",34,56789012,"Paysandú","Dependiente",true),
  new Persona("Carmen","Fernández",48,67890123,"Rivera","Independiente",true),
  new Persona("Diego", "López", 31, 78901234, "Tacuarembó", "Estudiante", true),
  new Persona("Teresa","Sánchez",25,89012345,"Cerro Largo","Dependiente",true),
  new Persona("Sergio", "Silva", 52, 90123456, "Rocha", "Independiente", true),
  new Persona("Beatriz","Ramírez",44,23456712,"Treinta y Tres","No Trabaja",true),
  new Persona("Rodrigo","Mendoza",30,34567123,"Durazno","Independiente",true),
  new Persona("Laura","Gutierrez",29,45671234,"Artigas","Estudiante",true),
  new Persona("Pedro","Torres",60,56712345,"San José","Independiente",true),
  new Persona("Gabriela","Peralta",21,67123456,"Colonia","No Trabaja",true),
  new Persona("Ernesto","Vargas",73,71234567,"Soriano","Dependiente",true),
  new Persona("Inés","Aguilar",45,81234568,"Río Negro","Independiente",false),
  new Persona("Julián","Cordero",33,91234569,"Lavalleja","Estudiante",false),
  new Persona("Sofía","Castillo",64,12345691,"Florida","No Trabaja",false),
  new Persona("Manuel", "Pinto", 50, 23456912, "Flores", "Dependiente", false),
  new Persona("Lucía", "Peña", 37, 34569123, "Rocha", "Estudiante", false),
  new Persona("Guillermo","Navarro",28,45691234,"Treinta y Tres","Dependiente",false),
  new Persona("Rosa","Lugo",22,56912345,"Canelones","Independiente",false),
  new Persona("Rafael", "Ríos", 40, 69123456, "Maldonado", "No Trabaja", false),
  new Persona("Estela","Palma",71,91234567,"Montevideo","Estudiante",false),
  new Persona("Nicolás","Vallejo",46,12345781,"Durazno","Dependiente",false),
  new Persona("Mariana","Quintero",35,23457812,"Tacuarembó","Independiente",false),
  new Persona("Armando","Zúñiga",64,34578123,"Paysandú","No Trabaja",false),
  new Persona("Isabel", "Vega", 23, 45781234, "Rivera", "Estudiante", false),
  new Persona("Carlos", "Yáñez", 39, 57812345, "Salto", "Dependiente", false),
  new Persona("Graciela","Ximénez",28,78123456,"Artigas","Independiente",false)
];
...
class SistemaPersona {
  ...
  existePersona(cedulaPersona) {
    ...
    for (let i = 0; i < this.personas.length; i++) {
      //recorre el arreglo persona
      const objCedula = this.personas[i].cedula;
      if (cedulaPersona === objCedula) {
        //evalua si la cedula de la persona coincide con la cedula ingresada
        existe = true;
        break;
      }
    }
