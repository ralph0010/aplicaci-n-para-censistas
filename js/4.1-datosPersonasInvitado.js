...
function ingresarPersonaInvitado() {
  ...
  //   if (!sistema.existePersona(cedulaNumber)) {
  //     if (
  ...
  //       mensaje =
  //         "Ingreso al sistema correctamente. El censista asignado es: " +
  //         sistema.mostrarCensistaAsignado(cedulaNumber);
